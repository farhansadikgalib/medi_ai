    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Padding(
          ...
          child: Row(
            children: [
              Image.asset('assets/icons/app_logo.png', height: 35, width: 35),
              const SizedBox(width: 5),
              Text("Alert!", style: textRegularStyle(color: Colors.black)),
            ],
          ),
        ),
        content: Padding(
        ...
        actions: <Widget>[
          TextButton(
            ...
            child: Text('No', style: textRegularStyle(color: AppColors.black)),
          ),
          TextButton(
            onPressed: () {
              DebounceHelper().debounce(
            ...
            child: Text('Yes', style: textRegularStyle(color: AppColors.black)),
          ),
        ],
      ),
    );
