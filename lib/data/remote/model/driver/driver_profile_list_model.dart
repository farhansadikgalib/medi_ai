...
DriverProfileListModel driverProfileListModelFromJson(String str) => DriverProfileListModel.fromJson(json.decode(str));

String driverProfileListModelToJson(DriverProfileListModel data) => json.encode(data.toJson());
...
class DriverProfileListModel {
  ...
  factory DriverProfileListModel.fromJson(Map<String, dynamic> json) => DriverProfileListModel(
    status: json["status"],
    data: json["data"] == null ? [] : List<DriverProfile>.from(json["data"]!.map((x) => DriverProfile.fromJson(x))),
